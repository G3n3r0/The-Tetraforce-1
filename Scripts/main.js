x$(window).on("load", function() {
    ...
    function Player(x,y,img) {
        ...
        this.sSheet = new SpriteSheet(this.img, 32, 32,this.fdata);
        this.bs = new BitmapSequence(this.sSheet);
        this.bs.y = this.y;
	    this.bs.x = this.x;
        this.bs.gotoAndStop("b");
